...
select models.name, brand_name, headquarters from brands join models on brands.name = models.brand_name where brand_name='Ford' and models.name='Mustang';
...
select b.name, founded from brands as b left join models as m on b.name=m.brand_name where m.brand_name is NULL;
...
select models.brand_name from models group by models.brand_name having count(models.brand_name)> 5;
...
select models.name, models.year from brands join models on brands.name=models.brand_name where models.year in (select brands.founded from brands);